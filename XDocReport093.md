...
The XDocReport team provides release bundles hosted on the **[Downloads](http://code.google.com/p/xdocreport/downloads/list)** tab in ZIP. As XDocReport is modular, it exists a ZIP per configuration. For instance if you wish manage Docx with Velocity and convert your report to PDF, XHTML, you must download **[docxandvelocity.converters-0.9.3-sample.zip](http://code.google.com/p/xdocreport/downloads/list)**. This ZIP contains required XDocReport and dependant (POI,...) JARs and source code with sample.
...
|:-------------|:-------------|:--------------|
| Docx       | Freemarker |     | **[docxandfreemarker-0.9.3-sample.zip](http://code.google.com/p/xdocreport/downloads/list)** |
| Docx       | Velocity |       | **[docxandvelocity-0.9.3-sample.zip](http://code.google.com/p/xdocreport/downloads/list)** |
| Docx       | Velocity |     PDF/XHTML      | **[docxandvelocity.converters-0.9.3-sample.zip](http://code.google.com/p/xdocreport/downloads/list)** |
| PPTX       | Velocity |     PDF/XHTML      | **[pptxandvelocity-0.9.3-sample.zip](http://code.google.com/p/xdocreport/downloads/list)** |

#### Open/Libre Office ####

| ODP       | Velocity |      | **[odpandvelocity-0.9.3-sample.zip](http://code.google.com/p/xdocreport/downloads/list)** |
|:----------|:---------|:-----|:------------------------------------------------------------------------------------------|
| ODT       | Velocity |      | **[odtandvelocity-0.9.3-sample.zip](http://code.google.com/p/xdocreport/downloads/list)** |
| ODT       | Velocity |     PDF/XHTML      | **[odtandvelocity.converters-0.9.3-sample.zip](http://code.google.com/p/xdocreport/downloads/list)** |
...
## New Features ##
  ...
  * Text styling : see [issue 43](http://code.google.com/p/xdocreport/issues/detail?id=43). See [Text styling demo](http://xdocreport.opensagres.cloudbees.net/textStyling.jsp) and documentation :
    * for docx please read [here](http://code.google.com/p/xdocreport/wiki/DocxReportingJavaMainTextStyling).
    * for odt please read [here](http://code.google.com/p/xdocreport/wiki/ODTReportingJavaMainTextStyling).
  * Improve dynamic image to manage size of image to insert: see [issue 51](http://code.google.com/p/xdocreport/issues/detail?id=51). Please read wiki:
    * for docx please read [here](http://code.google.com/p/xdocreport/wiki/DocxReportingJavaMainDynamicImage#Customize_size_of_image).
    * for odt please read [here](http://code.google.com/p/xdocreport/wiki/ODTReportingJavaMainDynamicImage#Customize_size_of_image).
  * Fix several bugs (hyperlink which must not processed, mergeifield with servelar w:instrText, attribut evalue with special characters like &amp;) with docx see [Issue 47 in xdocreport: Page numbers in footer and TOC disappears](http://code.google.com/p/xdocreport/issues/detail?id=47&can=1).